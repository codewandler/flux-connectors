...
> [!WARNING]
> **v0.26.0 is a compiler, a catalogue and a Tool pack.** None of the published crates opens a socket;
...
The repository currently contains **835 curated connector operations across 55 providers and 70
services**, plus 53 events and 5 channel bindings. It also publishes 77 Flux-owned core operations, node
kinds and capability records, and 3 core JSON Schemas. A full build compiles everything into **1173
...
```text
1173 artifacts up to date (55 providers checked)
```
...
```bash
base=https://github.com/codewandler/flux-connectors/releases/download/v0.26.0
