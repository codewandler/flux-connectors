...
The repository currently contains **232 curated connector operations across 41 providers and 48
...
```text
454 artifacts up to date (41 providers checked)
```
...
- **OpenAPI ingest is not wired.** All 41 providers are hand-authored, and `specs/` currently vendors
