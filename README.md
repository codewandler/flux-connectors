...
> [!WARNING]
> **v0.25.0 is a compiler, a catalogue and a Tool pack.** None of the published crates opens a socket;
...
```bash
base=https://github.com/codewandler/flux-connectors/releases/download/v0.25.0
