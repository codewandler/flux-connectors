...
- [C-191 — Publish the explorer components as an npm package — C-142's deferral condition is met](C-191-publish-the-explorer-components.md) · Surfaces · C-142 deferred extraction 'until a second consumer exists'. babelforce's ai-agent-platform console is that second consumer, filed 2026-07-31. The deferral was conditional and the condition is now true
