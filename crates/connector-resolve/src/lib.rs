...
//! `crates/connector-cli/tests/dependency_fence.rs::the_plan_deriving_core_is_engine_free` asserts
//! that over the resolved dependency graph rather than over this paragraph.
//!
