...
pub use config::{Binding, Choice, ConfigField, Format, Level, Pin, Position};
...
pub use ir::{
    ...
    ParamSet, ProducedCredential, Provenance, Quirks, RateLimit, Risk, Role, Runtime, Service, Tag,
